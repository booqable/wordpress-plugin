...
<div class="wrap bq-admin-wrap">
  ...
  <div class="card">
    <h2><?php _e("1. Connect your Booqable account"); ?></h2>
        ...
        <tbody>
          <tr>
            ...
            <td>
              ...
              <p class="description"><?php _e("You can find your <b>Company ID</b> under <b>Settings > Shop</b> in your Booqable account." ); ?></p>
            </td>
          </tr>
        </tbody>
      </table>
